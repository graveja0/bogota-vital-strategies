...
Click on Model {{< fa arrow-right >}} New Markov {{< fa arrow-right >}} model to start a new model in Amua.

![](images/clipboard-2052749061.png){fig-align="center" width="400"}
...
As in the Decision Tree case study, we'll next add in two additional strategies that aim to reduce the probability of injury:
