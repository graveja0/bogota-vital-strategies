...
::: callout-important
You will need to allow Amua to extrapolate some probabilities outside the specified age ranges. To do this, select the "Extrapolate" field and set it to "Yes":

![](images/clipboard-1378174773.png)
:::
...
*Make sure you create a variable and not a parameter.* Under “Variables”, click <img src="../amua-images/add_16.png" alt="Custom Icon" width="20" height="20"/> to add a variable

`p_injury_t = tbl_p_injury[age_initial + t, 1].`
...
# Add Regulate and Ban Scenarios
