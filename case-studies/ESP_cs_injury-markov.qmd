...
-   En la Cadena de Markov <img src="../amua-images/markovChain_24.png" alt="Custom Icon" width="20" height="20"/> , cambie las probabilidades iniciales de los estados de salud. Como todos los pacientes empiezan en el estado Vivo, cambie el p:0 de la izquierda del estado Local a p:1 (vea el cuadro azul de abajo).
...
Primero definimos una tabla de consulta <img src="../amua-images/table_16.png" alt="Custom Icon" width="20" height="20"/> tbl_death para leer la mortalidad de fondo dependiente de la edad construida a partir de las tablas de vida colombinas.
...
La recompensa por defecto en Amua es el coste. Tenemos que cambiar esto para tener la esperanza de vida (LE) como una recompensa. Ir a Modelo {{< fa arrow-right >}} Propiedades {{< fa arrow-right >}} seleccione la pestaña Análisis y cambie la dimensión de coste a LE. Utilice LE como símbolo y ajuste a 4 decimales.

![](images/clipboard-896605952.png){fig-align="center" width="500"}

Añada la esperanza de vida a la izquierda de cada estado de salud después de "R: (LE)".
...
::: callout-tip
Su resultado de esperanza de vida (EV) devolverá ahora el *total* de años de vida esperados para una cohorte de 100.000 personas. Para obtener un resultado de esperanza de vida estándar, puede redefinir el "resultado" para el resultado LE como $1/100000$.
