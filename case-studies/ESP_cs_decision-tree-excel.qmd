...
1.  1. Utilizando el cuadro de asignación de nombres situado en la parte superior izquierda de la hoja de cálculo. Esto es útil para nombrar un elemento a la vez.
2.  2. Nombrando por lotes utilizando una selección de tabla.
