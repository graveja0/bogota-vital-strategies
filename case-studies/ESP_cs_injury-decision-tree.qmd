...
::: callout-tip
Puede editar los resultados haciendo clic en Modelo {{< fa flecha-derecha >}} Propiedades {{< fa flecha-derecha >}} Análisis:
...
::: aviso
Puede introducir el tamaño de la cohorte haciendo clic en Modelo {{< fa flecha-derecha >}} Propiedades {{< fa flecha-derecha >}} Simulación:
...
Añada resultados adicionales basados en cada tipo de lesión (leve/moderada, grave, mortal). Utilice su árbol de decisión para proyectar las lesiones en general y por tipo según cada estrategia. Utilice los resultados para rellenar la tabla siguiente. En cada celda debe haber un recuento calculado del número de cada tipo de lesión en cada estrategia.
