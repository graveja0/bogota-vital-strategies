...
| Description                             | Base Case Value | Parameter Name |
|-----------------------------------------|-----------------|----------------|
| Coste de las lesiones leves o moderadas | 2.000.000 COP   | c_mod          |
| Coste de las lesiones graves            | 40.000.000 COP  | c_grave        |
| Coste de la lesión mortal               | 0 COP           | c_fatalidad    |
| Coste de las secuelas leves/moderadas   | 1.000.000 COP   | c_sec_mod      |
| Coste de las secuelas graves            | 4.000.000 COP   | c_sec_grave    |
