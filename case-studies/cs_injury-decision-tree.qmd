...
| Probability of Recovery: Major Injury         | 0.4             | p_recover_severe  |

## Strategies and Impact

When the mayor of Bogota banned the sale of fireworks in 1995, fireworks-related burns fell by 62%, from 204 in the 1994-1995 Christmas season to 77 during the 1995-1996 season. We will assume a similar 60% relative risk reduction under the "Ban" scenario.

By comparison, we will assume that stricter regulation will reduce firework injuries by just 15%. We will examine the sensitivity of our findings to these assumpions later in the case study.
...
| Description                                                                     | Base Case Value | Parameter Name |
|-----------------------------------------|----------------|----------------|
| Relative risk reduction: probability of injury under "Ban" policy scenario      | 0.6             | rr_ban         |
| Relative risk reduction: probability of injury under "Regulate" policy scenario | 0.85            | rr_ban         |
