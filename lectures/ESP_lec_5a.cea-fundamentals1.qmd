...
-   Los beneficios se valoran en términos de resultados clínicos (por
    ...
    ganados, años de vida ganados ajustados a la calidad)
...
-   Año de vida ajustado por calidad (AVAC): Una métrica que refleja
    tanto como la calidad de vida (dolor, función o ambos).
-   Es la forma de evaluación económica más publicada.
:::

::: fragment
::: {.callout-note appearance="simple"}
A lo largo del taller nos centraremos principalmente en el ACE
(especialmente en el ACU).
:::
:::
...
-   Criterio costo-beneficio: los beneficios de un programa son
    ...
    -   Obsérvese que no estamos haciendo comparaciones entre
        ...
        misma estrategia. estrategia\]{style="background-color:
        yellow;"}
...
-   Relevante cuando las alternativas sanitarias tienen diferentes
    costos y consecuencias para la salud consecuencias para la salud
    <br>
...
-   El VALOR relativo de una intervención en comparación con su
    alternativa se expresa en forma de RELACION costo-efectividad (¡el
    tema central de la próxima sesión)
...
(2) Un RESULTADO CLAVE en los análisis costo-efectividad es lo que se
    denomina RCEI \[o relación costo-efectividad incremental\], que nos
    da el valor relativo de una intervención frente a una alternativa.
...
(4) En las próximas semanas impartiremos 2 clases completas sobre los
    ICER y cómo interpretar estos relaciónes entre intervenciones.
    interpretar estos relaciónes entre intervenciones En lo que nos
...
::: notes
Si nos fijamos en cómo se utiliza la relación costo-efectividad en todo
el mundo --

A diferencia de Estados Unidos, los gobiernos de muchos países tienen
sus propios que realizan evaluaciones formales de la relación
...
(1) El Reino Unido - que es un sistema de pagador único conocido como el
    ...
    relación costo-efectividad NICE recomienda al NHS lo que debe cubrir
    en función de su VALOR. NICE recomienda al NHS lo que debe cubrir
...
(1) A continuación nos adentraremos en los componentes de los análisis
    ...
    NUMERADOR de la relación costo-efectividad y, a continuación,
...
3.  **Valor** -- Aplicar costos unitarios a cada categoría de recursos
    ...
    tarifas salariales nacionales para salarios del personal, costo por
    día de hospitalización para la estancia)
...
-   Costos de productividad ('costos indirectos')\*\*\]{style="color:
    #57886C"}
...
-   **Costo bruto ("top-down")**
    ...
    -   Ejemplo: Costos descendentes (por ejemplo, hospitalización por
        sobredosis de opiáceos) sobredosis de opiáceos)
...
-   Pérdidas de productividad de los pacientes asociadas al tamizaje o
    al tratamiento del cáncer\]{style="background-color: yellow;"}
...
-   No es necesario para CEA pero puede ser útil en algunas situaciones:
    ...
    -   Ejemplo: puede ser necesario convertir la moneda local a USD
        porque porque los umbrales de costo-efectividad suelen estimarse
        en USD por AVAD.
