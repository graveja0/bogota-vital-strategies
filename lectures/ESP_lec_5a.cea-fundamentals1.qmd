...
-   El VALOR relativo de una intervención en comparación con su
    alternativa se expresa en forma de RATIO costo-efectividad (¡el tema
...
(2) Un RESULTADO CLAVE en los análisis costo-efectividad es lo que se
    denomina RCEI \[o ratio costo-efectividad incremental\], que nos da
...
(4) En las próximas semanas impartiremos 2 clases completas sobre los
    ICER y cómo interpretar estos ratios entre intervenciones.
    interpretar estos ratios entre intervenciones En lo que nos
