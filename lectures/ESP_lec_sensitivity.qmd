...
## Análisis de sensibilidad unidireccional

::: incremental
- Suele ser el punto de partida de los análisis de sensibilidad
- Probar secuencialmente una variable cada vez (es decir, edad, IMC, AVAC, otros parámetros clínicamente importantes), manteniendo todo lo demás constante.
...
## Estudio de caso sobre el rotavirus en Capstone

![](images/file_show2.jpeg)

## Rotavirus estudio de caso de Capstone
...
## Incentivos económicos para la atención del ictus agudo

![](images/Screen%20Shot%202022-09-28%20at%2010.25.53%20PM.png){width="543"}

## Incentivos financieros para la atención del ictus agudo
...
- Objetivo del estudio: Ilustrar cómo los incentivos de pago por resultados pueden limitarse cuantitativamente mediante modelos de coste-efectividad, a través de la **aplicación del reembolso a los hospitales por un tiempo más rápido hasta el ATP para el ictus isquémico agudo**.
:::

## Incentivos económicos para la atención del ictus agudo

> Cuando se administra rápidamente tras el inicio del ictus (en un plazo de tres horas, según lo aprobado por la FDA), el tPA ayuda a restablecer el flujo sanguíneo a las regiones cerebrales afectadas por un ictus, limitando así el riesgo de daños y deterioro funcional.
...
- Responde a la pregunta Cuál debe ser el parámetro de entrada para alcanzar los umbrales por país de:
    - 50.000 $/QALY ganado
    - 100.000 $/QALY ganados
    - 150.000 $/QALY ganados
    - 200.000 $/QALY ganados
