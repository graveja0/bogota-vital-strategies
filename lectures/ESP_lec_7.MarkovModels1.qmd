...
::: incremental
-   Supongamos que queremos modelizar la relación costo-efectividad de
...
# Construyendo un Modelo Markov  {background="#43464B"}
...
### {{< fa check-circle >}} 3b. Identificar y definir las entradas del modelo
...
-   Con nuestras trazas de Markov completas, podemos calcular los
...
Veamos la traza de Markov y los resultados del ciclo para el resultado
años de vida.
...
-   Cuando discretizamos el tiempo utilizando una longitud de ciclo
    ...
    -   Supongamos que se trata de un simple bien $\arrow$ proceso
        muerto
...
# Aplicar corrección mitad del ciclo a nuestra traza de Markov...
